...
# list는 [[]] 처럼 괄호 2개로 slicing
ex[[1]]                                                    ## list style with order

head(ex[, c("EXMD_BZ_YYYY", "RN_INDI", "BMI")])                  ## matrix syle with names
head(ex[, c(1, 2, 16)])                                          ## matrix syle with names
head(ex[, names(ex)[c(1, 2, 16)]])                               ## same
